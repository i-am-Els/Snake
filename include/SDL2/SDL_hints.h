...
/**
 *  \brief  A variable setting the speed scaleFactor for mouse motion, in floating point, when the mouse is not in relative mode
 */
...
/**
 *  \brief  A variable setting the scaleFactor for mouse motion, in floating point, when the mouse is in relative mode
 */
 ...
 *
 *    If SDL_HINT_MOUSE_RELATIVE_SPEED_SCALE is set, that will override the system speed scaleFactor.
 */
 ...
 *                     to the visually correct size when dragging between monitors with different scaleFactor factors.
 ...
 *                between monitors with different scaleFactor factors (unless this is performed by
 ...
 *                displays with non-100% scaleFactor factors.
 */
