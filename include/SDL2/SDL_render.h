...
/**
 * Set the scaleFactor mode used for texture scaleFactor operations.
 *
 * If the scaleFactor mode is not supported, the closest supported mode is chosen.
 *
 * \param texture The texture to update.
...
/**
 * Get the scaleFactor mode used for texture scaleFactor operations.
 *
 * \param texture the texture to query.
 * \param scaleMode a pointer filled in with the current scaleFactor mode.
...
/**
 * Set the drawing scaleFactor for rendering on the current target.
 *
...
/**
 * Get the drawing scaleFactor for the current target.
 *
 * \param renderer the renderer from which drawing scaleFactor should be queried
